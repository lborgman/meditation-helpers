// @ts-check
const SAFE_AUDIOCONTEXT_VER = "0.0.02";
window["logConsoleHereIs"](`here is safe-audiocontext.js, module, ${SAFE_AUDIOCONTEXT_VER}`);
if (document.currentScript) { throw "safe-audiocontext.js is not loaded as module"; }
